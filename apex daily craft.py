...
craft = on_keyword(['craft','CRAFT'],priority=50)
@craft.handle()
async def craft_handle(bot: Bot, event: Event):
  await craft.send('正在查询今日制造轮换，请稍候', at_sender=True)
...
#下载图片
  ...
  IMAGE_SAVE_PATH = 'E:\qqbot\mobot\\final.jpg'  # 图片转换后的地址
...
# 定义图像拼接函数
  ...
  await craft.send(MessageSegment.image('file:///E:/qqbot/mobot/final.jpg'))